...
//object Colors {
//
//    val primary = Color(0xff51f0cd)
//    val secondary = Color(0xffff3b78)
//    val secondaryLighter = Color(0xFFfa9a86)
//
//    val imageBackground = Color(0xFF999999)
//    val darkBlue = Color(0xff5a41d9)
//    val lightGreen = Color(0xffc0d93f)
//    val orange = Color(0xfff19b46)
//
...
val md_theme_light_secondary = Color(0xffe0d438) //Color(0xFF333333) // *darkGrey51 в первичном наборе
val md_theme_light_onSecondary = Color(0xFF333333) //Color(0xFCFFFF) //*imageBackground в первичном наборе
...
val md_theme_light_background = Color(0x00000000) //(0xFFFFFFFF)
val md_theme_light_onBackground = Color(0xFFFFFFFF) //Color(0xFF1C1B1F)
//val md_theme_light_surface = Color(0xffe0d438)  //Цвета бэкграундов, их в % больше всего на светлой теме
val md_theme_light_onSurface = Color(0xFF1C1B1F)
val md_theme_light_surfaceVariant = Color(0xFFE7E0EC)
val md_theme_light_onSurfaceVariant = Color(0xFF49454F) //Имена игроков во вкладке Day
